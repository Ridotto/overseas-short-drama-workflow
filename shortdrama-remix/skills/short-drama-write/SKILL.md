...
`/dialogue-polish` 不准把作者句、心理解释句、情绪总结句，润色成更漂亮的作者句。

以下方向一律不算合格 surface polish：

- 直接替观众解释人物“心门开了 / 关了”
- 直接总结人物“心软了 / 心冷了 / 情绪回来了”
- 直接总结人物“什么东西在他/她身上碎了”
- 用单个漂亮句替观众下人格或情绪判断
- 用标签化短语代替现场反应，例如把人物写成“可怜 / 无辜 / 安全 / 体面 / 崩溃”

如果输入里已经有抽象心理句，polish 的职责不是美化它，而是把它压回可见事件：手松开 / 停住、下颌收紧、眼神避开、身体一缩、停顿、物件被拿走 / 放下 / 砸下、空间位置改变、沉默、被打断、旁人反应。
...
10. 逐场做 key-turn regression check：重点检查动摇、态度回收 / 信任回收 / 关系转冷、羞辱、失位、装弱、克制、真相刺激、身体伤害、关系转折这些关键情绪转折位。如果这些位置仍靠作者句、心理总结句或标签化解释句表达，surface pass 不算完成。
11. 如果不改变剧情事实就无法把作者句可见化，必须停下并归因；不准硬写更漂亮、更抽象的替代句。
12. 逐场复核：不得改变核心设定、人物关系、真相顺序、本集核心代价、结尾债务、状态增量和已确认蓝图承诺。
13. 清掉空泛 AI 腔，但不得误删有效短剧套路句。
14. 保留并同步 `## 状态增量`，不得新增状态事实。
15. 追加 `## Dialogue Polish Notes`，说明本次逐场 surface pass 重点、保留的硬锚点和未改动事实边界。
