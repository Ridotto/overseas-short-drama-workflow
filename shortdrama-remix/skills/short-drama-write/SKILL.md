...
{
  "currentStep": "start|plan|characters|outline|episode|dialogue-polish|review|batch-state|export",
  "genre": [],
  "audience": "",
  "tone": "",
  "totalEpisodes": 0,
...
2. 检查源本导入是否完整：
   ...
   - 交接包必须包含首批信息释放/继续扣住、角色状态压力和一眼可懂代价
...
- 第 1-10 集必须形成最低看点承诺：每集至少有一个可见损失、反派主动新伤害、关系断点、身份/权力/身体代价或强钩子。
